(function($){
	$(document).ready(function() {
		...
		if ($('.widget-contact-contact-9:first-Child .telCentro', window.parent.document).length<1)
		{
			...
			$('.widget-contact-contact-9:last-Child [data-aid=CONTACT_INFO_ADDRESS_REND]+[data-ux=ContentText]', window.parent.document).addClass('innerTel');
			...
			$('.widget-contact-contact-9 .innerTel', window.parent.document).append($('#6bda68c0-32f3-4be1-af1c-fdd6e1c39d82 [data-aid="CONTENT_WELCOME_DESCRIPTION_RENDERED"]', window.parent.document));
			$('.widget-contact-contact-9:first-Child .telCentro', window.parent.document).after($('.widget-contact-contact-9:first-Child .RelogCentro', window.parent.document));
			$('.widget-contact-contact-9:last-Child .telCentro', window.parent.document).after($('.widget-contact-contact-9:last-Child .RelogCentro', window.parent.document));
			$('.widget-contact-contact-9:last-Child .RelogCentro', window.parent.document).after($('.widget-contact-contact-9:last-Child .whatsCentro', window.parent.document));
			$('#6bda68c0-32f3-4be1-af1c-fdd6e1c39d82', window.parent.document).remove();
		}
	});
})(jQuery);
